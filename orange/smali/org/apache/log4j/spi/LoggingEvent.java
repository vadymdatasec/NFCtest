public class org.apache.log4j.spi.LoggingEvent implements java.io.Serializable {
	 ...
	 /* # direct methods */
	 public static org.apache.log4j.spi.LoggingEvent ( ) {
		 /* .locals 2 */
		 /* .line 1 */
	 ...
	 public org.apache.log4j.spi.LoggingEvent ( ) {
		 /* .locals 1 */
		 /* .line 21 */
...
public void getMDCCopy ( ) {
	 ...
	 public java.lang.Object getMessage ( ) {
		 ...
		 (( org.apache.log4j.spi.LoggingEvent ) p0 ).getRenderedMessage ( ); // invoke-virtual {p0}, Lorg/apache/log4j/spi/LoggingEvent;->getRenderedMessage()Ljava/lang/String;
	 } // .end method
	 ...
	 public java.util.Map getProperties ( ) {
		 /* .locals 1 */
		 /* .line 1 */
		 (( org.apache.log4j.spi.LoggingEvent ) p0 ).getMDCCopy ( ); // invoke-virtual {p0}, Lorg/apache/log4j/spi/LoggingEvent;->getMDCCopy()V
		 /* .line 2 */
		 v0 = this.d;
		 /* if-nez v0, :cond_0 */
		 /* .line 3 */
...
public final java.lang.String getProperty ( java.lang.String p0 ) {
	 /* .locals 0 */
	 /* .line 1 */
	 (( org.apache.log4j.spi.LoggingEvent ) p0 ).getMDC ( p1 ); // invoke-virtual {p0, p1}, Lorg/apache/log4j/spi/LoggingEvent;->getMDC(Ljava/lang/String;)Ljava/lang/Object;
...
/* .locals 1 */
/* .line 1 */
(( org.apache.log4j.spi.LoggingEvent ) p0 ).getProperties ( ); // invoke-virtual {p0}, Lorg/apache/log4j/spi/LoggingEvent;->getProperties()Ljava/util/Map;
} // .end method
...
public java.lang.Object removeProperty ( java.lang.String p0 ) {
/* .locals 1 */
/* .line 1 */
v0 = this.d;
/* if-nez v0, :cond_0 */
