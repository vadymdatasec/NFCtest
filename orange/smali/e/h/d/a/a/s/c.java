public class e.h.d.a.a.s.c extends e.h.d.a.a.s.k0.d {
	 /* .source "SourceFile" */
	 /* # instance fields */
	 public final com.orange.oab.contactless.packid.hce.user.User a;
	 /* # direct methods */
	 public e.h.d.a.a.s.c ( ) {
		 /* .locals 0 */
		 /* .line 1 */
	 ...
	 public java.lang.Object a ( android.database.sqlite.SQLiteDatabase p0 ) { //bridge//synthethic
		 /* .locals 0 */
		 /* .line 1 */
		 (( e.h.d.a.a.s.c ) p0 ).a ( p1 ); // invoke-virtual {p0, p1}, Le/h/d/a/a/s/c;->a(Landroid/database/sqlite/SQLiteDatabase;)Ljava/lang/Void;
	 } // .end method
...
/* .line 11 */
(( android.database.sqlite.SQLiteDatabase ) p1 ).update ( v1, v0, v2, v2 ); // invoke-virtual {p1, v1, v0, v2, v2}, Landroid/database/sqlite/SQLiteDatabase;->update(Ljava/lang/String;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
} // .end method
