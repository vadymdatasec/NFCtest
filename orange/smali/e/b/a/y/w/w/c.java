public class e.b.a.y.w.w.c implements e.b.a.y.w.w.f {
	 /* .source "SourceFile" */
	 /* # interfaces */
	 /* # static fields */
	 ...
	 public android.database.Cursor a ( android.net.Uri p0 ) {
		 ...
		 /* .line 2 */
		 v0 = this.a;
		 v1 = android.provider.MediaStore$Images$Thumbnails.EXTERNAL_CONTENT_URI;
		 v2 = e.b.a.y.w.w.c.b;
		 int v3 = 1; // const/4 v3, 0x1
		 /* new-array v4, v3, [Ljava/lang/String; */
		 int v3 = 0; // const/4 v3, 0x0
		 /* aput-object p1, v4, v3 */
		 final String v3 = "kind = 1 AND image_id = ?"; // const-string v3, "kind = 1 AND image_id = ?"
