public class e.f.c.l.e.m.e2 implements e.f.a.b.h.a {
	 /* .source "SourceFile" */
	 /* # interfaces */
	 /* # annotations */
...
/* # instance fields */
public final e.f.a.b.h.h a; //synthetic
/* # direct methods */
public e.f.c.l.e.m.e2 ( ) {
	 /* .locals 0 */
	 /* .line 1 */
	 this.a = p1;
...
/* .line 1 */
(( e.f.c.l.e.m.e2 ) p0 ).a ( p1 ); // invoke-virtual {p0, p1}, Le/f/c/l/e/m/e2;->a(Le/f/a/b/h/g;)Ljava/lang/Void;
} // .end method
public java.lang.Void a ( Object p0 ) {
/* .locals 1 */
/* .annotation system Ldalvik/annotation/Signature; */
/* value = { */
/* "(", */
