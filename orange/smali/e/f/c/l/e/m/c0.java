public class e.f.c.l.e.m.c0 implements java.util.Comparator {
	 /* .source "SourceFile" */
	 /* # interfaces */
	 /* # annotations */
...
public Integer a ( java.io.File p0, java.io.File p1 ) {
	 ...
	 p1 = 	 (( java.lang.String ) p2 ).compareTo ( p1 ); // invoke-virtual {p2, p1}, Ljava/lang/String;->compareTo(Ljava/lang/String;)I
} // .end method
public Integer compare ( java.lang.Object p0, java.lang.Object p1 ) { //bridge//synthethic
	 ...
	 p1 = 	 (( e.f.c.l.e.m.c0 ) p0 ).a ( p1, p2 ); // invoke-virtual {p0, p1, p2}, Le/f/c/l/e/m/c0;->a(Ljava/io/File;Ljava/io/File;)I
} // .end method
