public abstract class c.h.f.i.b {
	 /* .source "SourceFile" */
	 /* # static fields */
...
public static Float a ( Integer p0 ) {
/* .locals 0 */
/* .line 2 */
p0 = c.h.f.i.b .d ( p0 );
p0 = c.h.f.i.b .b ( p0 );
...
p0 = /* invoke-static/range {v9 ..v14}, Lc/h/g/a;->a(DDD)I */
} // .end method
...
public static Float b ( Integer p0 ) {
/* .locals 5 */
/* int-to-float p0, p0 */
...
public static Float c ( Float p0 ) {
/* .locals 5 */
/* const/high16 v0, 0x42c80000 # 100.0f */
...
public static c ( Integer p0 ) {
/* .locals 9 */
/* .line 1 */
v0 = android.graphics.Color .red ( p0 );
v0 = c.h.f.i.b .b ( v0 );
/* .line 2 */
v1 = android.graphics.Color .green ( p0 );
v1 = c.h.f.i.b .b ( v1 );
/* .line 3 */
...
public static Float d ( Integer p0 ) {
/* .locals 6 */
/* .line 1 */
v0 = android.graphics.Color .red ( p0 );
v0 = c.h.f.i.b .b ( v0 );
