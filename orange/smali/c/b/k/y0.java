public class c.b.k.y0 {
	 /* .source "SourceFile" */
	 /* # static fields */
	 public static c.b.k.y0 d;
	 /* # instance fields */
	 public Long a;
	 public Long b;
	 public Integer c;
	 ...
	 public static c.b.k.y0 a ( ) {
		 /* .locals 1 */
		 /* .line 1 */
		 v0 = c.b.k.y0.d;
		 /* if-nez v0, :cond_0 */
		 /* .line 2 */
		 /* new-instance v0, Lc/b/k/y0; */
		 /* invoke-direct {v0}, Lc/b/k/y0;-><init>()V */
		 /* .line 3 */
	 } // :cond_0
	 v0 = c.b.k.y0.d;
} // .end method
...
public void a ( Long p0, Double p1, Double p2 ) {
	 ...
	 /* if-ltz v8, :cond_0 */
	 /* .line 12 */
	 /* iput v5, v0, Lc/b/k/y0;->c:I */
	 /* .line 13 */
	 /* iput-wide v6, v0, Lc/b/k/y0;->a:J */
	 /* .line 14 */
	 /* iput-wide v6, v0, Lc/b/k/y0;->b:J */
	 return;
} // :cond_0
...
/* mul-double v9, v9, v11 */
/* .line 19 */
java.lang.Math .round ( v9,v10 );
/* move-result-wide v9 */
/* add-long/2addr v9, v1 */
/* iput-wide v9, v0, Lc/b/k/y0;->a:J */
/* sub-double/2addr v3, v6 */
/* mul-double v3, v3, v11 */
/* .line 20 */
java.lang.Math .round ( v3,v4 );
/* move-result-wide v3 */
/* add-long/2addr v3, v1 */
/* iput-wide v3, v0, Lc/b/k/y0;->b:J */
/* cmp-long v1, v3, p1 */
/* if-gez v1, :cond_2 */
/* .line 21 */
/* iget-wide v1, v0, Lc/b/k/y0;->a:J */
/* cmp-long v3, v1, p1 */
/* if-lez v3, :cond_2 */
/* .line 22 */
/* iput v8, v0, Lc/b/k/y0;->c:I */
