public class c.b.q.o extends android.widget.CheckBox implements c.h.o.q implements c.h.n.z {
	 /* .source "SourceFile" */
	 /* # interfaces */
	 /* # instance fields */
...
/* .locals 1 */
/* .line 4 */
(( android.widget.CheckBox ) p0 ).getContext ( ); // invoke-virtual {p0}, Landroid/widget/CheckBox;->getContext()Landroid/content/Context;
c.b.l.a.b .c ( v0,p1 );
(( c.b.q.o ) p0 ).setButtonDrawable ( p1 ); // invoke-virtual {p0, p1}, Lc/b/q/o;->setButtonDrawable(Landroid/graphics/drawable/Drawable;)V
return;
} // .end method
