public class c.b.q.l extends android.widget.AutoCompleteTextView implements c.h.n.z {
	 /* .source "SourceFile" */
	 /* # interfaces */
	 /* # static fields */
	 ...
	 public c.b.q.l ( ) {
		 ...
		 if ( v0 != null) { // if-eqz v0, :cond_0
			 ...
			 (( android.widget.AutoCompleteTextView ) p0 ).setDropDownBackgroundDrawable ( v0 ); // invoke-virtual {p0, v0}, Landroid/widget/AutoCompleteTextView;->setDropDownBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
			 /* .line 6 */
		 } // :cond_0
...
(( android.widget.AutoCompleteTextView ) p0 ).getContext ( ); // invoke-virtual {p0}, Landroid/widget/AutoCompleteTextView;->getContext()Landroid/content/Context;
c.b.l.a.b .c ( v0,p1 );
(( android.widget.AutoCompleteTextView ) p0 ).setDropDownBackgroundDrawable ( p1 ); // invoke-virtual {p0, p1}, Landroid/widget/AutoCompleteTextView;->setDropDownBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
return;
} // .end method
